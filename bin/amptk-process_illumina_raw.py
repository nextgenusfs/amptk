...
parser.add_argument('--mapping_file', required=True, help='QIIME-like mapping tool')
...
parser.add_argument('-m','--min_len', default=100, type=int, help='Minimum read length to keep')
